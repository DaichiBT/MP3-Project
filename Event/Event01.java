        ...
        switch (game.playerFamily.getTommyTalkCounter()) {
            ...
            case 2:
                if (!(game.playerFamily.getCheckedPhotoAlbum())) {
                    ...
                    game.stopSound(game.getTommyVoice(2));
                    game.playSound(game.getTommyVoice(3));
            ...
            case 3:
                if (!(game.playerFamily.getKnifeLifted())) {
                    game.stopSound(game.getTommyVoice(3));
                    game.playSound(game.getTommyVoice(4));
                    ...
                    game.stopSound(game.getTommyVoice(4));
                    game.playSound(game.getTommyVoice(5));
                    game.gameUI.messageText.setText("Tommy - \n\"Thank you for finding the note...\"");
                    game.playerFamily.setTommyTalkCounter();
                }
                break;
            case 4:
                game.stopSound(game.getTommyVoice(5));
                game.playSound(game.getTommyNote());
                game.gameUI.messageText.setText("Note -\nDear Tommy,\n\nI left some snacks for you in your bedroom...");
                game.playerFamily.setTommyTalkCounter();
                break;
            case 5:
                if (!(game.playerFamily.getGrabbedBag())) {
                    game.stopSound(game.getTommyNote());
                    game.playSound(game.getTommyVoice(6));
                    game.gameUI.messageText.setText("Tommy - \n\"Hey, do you think you can go find the snacks in my room?\"");
                } else {
                    game.stopSound(game.getTommyVoice(6));
                    game.playSound(game.getTommyVoice(7));
                    game.gameUI.messageText.setText("Tommy - \n\"Thank you, once again...\"");
                    game.playerFamily.setTommyTalkCounter();
                }
                break;
            case 6:
                game.stopSound(game.getTommyVoice(7));
                game.playSound(game.getTommyVoice(8));
            ...
            case 8:
                if (!game.playerFamily.getGraveExplored()) {
                    game.stopSound(game.getTommyVoice(8));
                    game.playSound(game.getTommyVoice(9));
                ...
                break;
            case 9:
                game.stopSound(game.getTommyVoice(9));
                game.playSound(game.getTommyVoice(10));
